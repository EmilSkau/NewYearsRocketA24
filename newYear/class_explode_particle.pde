class ExplodeParticle 
{
  ...
  void displayParticle(float xPos, float yPos) // xPos og yPos er der for at kunne have partiklerne tilfældigt placeret rund om eksplosionen.
  {
    ...
    fill(R, G, B); // Jeg har forsøgt på at få partiklerne til at forsvinde efter noget tid. Lidt ligesom du gør med eksplosionen. Men min hjerne kan ikke finde ud af det lige nu :)
